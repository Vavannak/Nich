...
API_TOKEN = "8165007703:AAGim8wO5DTL5g9b5QqsLkcklW-qVhwBePQ"
BEARER_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI3NDU2MDkzMTMzIiwiaWF0IjoxNzM1MTc1NTY1LCJleHAiOjE3NDAzNTk1NjV9.k85lKk7M19weiC18q2XbOQmFfOQIzBzS5erJIPHdKFU"
HEADERS = {
    ...
    while time.time() - start_time < 180:  # Check for 3 minutes
        try:
            check_response = requests.post(
                ...
                json={"md5": md5, "bakongToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiN2QxMjU4OTAxMWJkNDNjNyJ9LCJpYXQiOjE3MzUwOTIwMDgsImV4cCI6MTc0Mjg2ODAwOH0.fRfDEZamsI5dfY8mJJJziTsH3F1eSRRFO4f8OENYk0U"},
                headers=HEADERS
            ).json()
...
def generate_qr(message, amount):
    try:
        create_payload = {
            "type": "personal",
            "data": {
                "bakongAccountID": "dy_sokvun@trmc",
                "accName": "KSY STORE",
